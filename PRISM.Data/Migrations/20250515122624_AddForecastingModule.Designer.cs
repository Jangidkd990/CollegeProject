...
namespace PRISM.Data.Migrations
{
    ...
    [Migration("20250515122624_AddForecastingModule")]
    partial class AddForecastingModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRISM.Core.Entities.Forecasting.Forecast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PRISM.Core.Entities.Forecasting.ForecastDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PRISM.Core.Entities.Forecasting.UF6BorrowingRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PRISM.Core.Entities.Transportation.ShippingRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PRISM.Core.Entities.Transportation.TransportationPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PRISM.Core.Entities.Transportation.TransportationRoute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PRISM.Core.Entities.Contract.ContractDelivery", b =>
                {
                    ...
                    b.HasOne("PRISM.Core.Entities.Transportation.TransportationPlan", null)
            ...
            modelBuilder.Entity("PRISM.Core.Entities.Forecasting.ForecastDetail", b =>
                {
                    b.HasOne("PRISM.Core.Entities.Forecasting.Forecast", "Forecast")
                        .WithMany()
            ...
            modelBuilder.Entity("PRISM.Core.Entities.Forecasting.UF6BorrowingRecord", b =>
                {
                    b.HasOne("PRISM.Core.Entities.Forecasting.UF6BorrowingRecord", "RelatedRecord")
                        .WithMany()
            ...
            modelBuilder.Entity("PRISM.Core.Entities.Transportation.ShippingRate", b =>
                {
                    b.HasOne("PRISM.Core.Entities.Location.Location", "DestinationLocation")
                        .WithMany()
                        .HasForeignKey("DestinationLocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PRISM.Core.Entities.Location.Location", "OriginLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("PRISM.Core.Entities.Transportation.TransportationRoute", b =>
                {
                    b.HasOne("PRISM.Core.Entities.Location.Location", "FromLocation")
                        .WithMany()
                        .HasForeignKey("FromLocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PRISM.Core.Entities.Location.Location", "ToLocation")
                        .WithMany()
                        .HasForeignKey("ToLocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PRISM.Core.Entities.Transportation.TransportationPlan", "TransportationPlan")
                        .WithMany("Routes")
                        .HasForeignKey("TransportationPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
