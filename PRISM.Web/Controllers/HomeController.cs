...
public class HomeController : Controller
{
    ...
    private readonly IRepository<PRISM.Core.Entities.Contract.Contract> _contractRepository;

    public HomeController(
        ILogger<HomeController> logger,
        ApplicationDbContext dbContext,
        IRepository<PRISM.Core.Entities.Contract.Contract> contractRepository)
    {
        _logger = logger;
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var dashboardModel = new DashboardViewModel
        {
            ...
            PendingUF6RepaymentCount = await _dbContext.UF6BorrowingRecords.CountAsync(b => b.TransactionType == PRISM.Core.Entities.Forecasting.BorrowingTransactionType.Borrow && !b.IsSettled),
        };
